...
public final class AspectLookupGameTests {
    ...
    public static void existsStillReflectsRawRegistrations(GameTestHelper helper) {
        ...
        helper.assertTrue(computed.size() == 0,
                "Unregistered fixture without a recipe must compute empty");
        helper.assertTrue(!ThaumcraftApi.exists(unregistered),
    ...
    public static final class TestItems {
        ...
        static Item RECIPE_SEED;
        static Item RECIPE_OUTPUT;
        static Item RECIPE_NONE;
        static final java.util.Map<String, Item> RECIPE_ITEMS = new java.util.LinkedHashMap<>();
        ...
        public static void register(RegisterEvent event) {
            event.register(ForgeRegistries.Keys.ITEMS, helper -> {
                ...
                RECIPE_SEED = new Item(new Item.Properties());
                RECIPE_OUTPUT = new Item(new Item.Properties());
                RECIPE_NONE = new Item(new Item.Properties());
                helper.register("fnd04_recipe_seed", RECIPE_SEED);
                helper.register("fnd04_recipe_output", RECIPE_OUTPUT);
                helper.register("fnd04_recipe_none", RECIPE_NONE);
                RECIPE_ITEMS.put("water", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_water", RECIPE_ITEMS.get("water"));
                RECIPE_ITEMS.put("magic3", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_magic3", RECIPE_ITEMS.get("magic3"));
                RECIPE_ITEMS.put("magic5", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_magic5", RECIPE_ITEMS.get("magic5"));
                RECIPE_ITEMS.put("metal3", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_metal3", RECIPE_ITEMS.get("metal3"));
                RECIPE_ITEMS.put("metal8", new Item(new Item.Properties() .craftRemainder(RECIPE_ITEMS.get("metal3"))));
                helper.register("fnd04_recipe_metal8", RECIPE_ITEMS.get("metal8"));
                RECIPE_ITEMS.put("metal2", new Item(new Item.Properties() .craftRemainder(RECIPE_ITEMS.get("metal3"))));
                helper.register("fnd04_recipe_metal2", RECIPE_ITEMS.get("metal2"));
                RECIPE_ITEMS.put("earth1", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_earth1", RECIPE_ITEMS.get("earth1"));
                RECIPE_ITEMS.put("earth2", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_earth2", RECIPE_ITEMS.get("earth2"));
                RECIPE_ITEMS.put("earth5", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_earth5", RECIPE_ITEMS.get("earth5"));
                RECIPE_ITEMS.put("shaped", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_shaped", RECIPE_ITEMS.get("shaped"));
                RECIPE_ITEMS.put("divided", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_divided", RECIPE_ITEMS.get("divided"));
                RECIPE_ITEMS.put("promoted", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_promoted", RECIPE_ITEMS.get("promoted"));
                RECIPE_ITEMS.put("zero", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_zero", RECIPE_ITEMS.get("zero"));
                RECIPE_ITEMS.put("alternative", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_alternative", RECIPE_ITEMS.get("alternative"));
                RECIPE_ITEMS.put("remainder", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_remainder", RECIPE_ITEMS.get("remainder"));
                RECIPE_ITEMS.put("short_remainder", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_short_remainder", RECIPE_ITEMS.get("short_remainder"));
                RECIPE_ITEMS.put("arcane", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_arcane", RECIPE_ITEMS.get("arcane"));
                RECIPE_ITEMS.put("odd_arcane", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_odd_arcane", RECIPE_ITEMS.get("odd_arcane"));
                RECIPE_ITEMS.put("crucible", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_crucible", RECIPE_ITEMS.get("crucible"));
                RECIPE_ITEMS.put("infusion", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_infusion", RECIPE_ITEMS.get("infusion"));
                RECIPE_ITEMS.put("priority", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_priority", RECIPE_ITEMS.get("priority"));
                RECIPE_ITEMS.put("empty_priority", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_empty_priority", RECIPE_ITEMS.get("empty_priority"));
                RECIPE_ITEMS.put("infusion_priority", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_infusion_priority", RECIPE_ITEMS.get("infusion_priority"));
                RECIPE_ITEMS.put("empty_infusion", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_empty_infusion", RECIPE_ITEMS.get("empty_infusion"));
                RECIPE_ITEMS.put("minimum", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_minimum", RECIPE_ITEMS.get("minimum"));
                RECIPE_ITEMS.put("tie", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_tie", RECIPE_ITEMS.get("tie"));
                RECIPE_ITEMS.put("middle", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_middle", RECIPE_ITEMS.get("middle"));
                RECIPE_ITEMS.put("siblings", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_siblings", RECIPE_ITEMS.get("siblings"));
                RECIPE_ITEMS.put("cycle_a", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_cycle_a", RECIPE_ITEMS.get("cycle_a"));
                RECIPE_ITEMS.put("cycle_b", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_cycle_b", RECIPE_ITEMS.get("cycle_b"));
                RECIPE_ITEMS.put("registered", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_registered", RECIPE_ITEMS.get("registered"));
                RECIPE_ITEMS.put("late_seed", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_late_seed", RECIPE_ITEMS.get("late_seed"));
                RECIPE_ITEMS.put("late_output", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_late_output", RECIPE_ITEMS.get("late_output"));
                RECIPE_ITEMS.put("legacy", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_legacy", RECIPE_ITEMS.get("legacy"));
                RECIPE_ITEMS.put("legacy_infusion", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_legacy_infusion", RECIPE_ITEMS.get("legacy_infusion"));
                RECIPE_ITEMS.put("legacy_arcane", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_legacy_arcane", RECIPE_ITEMS.get("legacy_arcane"));
                RECIPE_ITEMS.put("reload_output", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_reload_output", RECIPE_ITEMS.get("reload_output"));
                ThaumcraftApi.registerObjectTag(new ItemStack(RECIPE_ITEMS.get("water")),new AspectList().add(Aspect.WATER,8));
                ThaumcraftApi.registerObjectTag(new ItemStack(RECIPE_ITEMS.get("magic3")),new AspectList().add(Aspect.MAGIC,3));
                ThaumcraftApi.registerObjectTag(new ItemStack(RECIPE_ITEMS.get("magic5")),new AspectList().add(Aspect.MAGIC,5));
                ThaumcraftApi.registerObjectTag(new ItemStack(RECIPE_ITEMS.get("metal3")),new AspectList().add(Aspect.METAL,3));
                ThaumcraftApi.registerObjectTag(new ItemStack(RECIPE_ITEMS.get("metal8")),new AspectList().add(Aspect.METAL,8));
                ThaumcraftApi.registerObjectTag(new ItemStack(RECIPE_ITEMS.get("metal2")),new AspectList().add(Aspect.METAL,2));
                ThaumcraftApi.registerObjectTag(new ItemStack(RECIPE_ITEMS.get("earth1")),new AspectList().add(Aspect.EARTH,1));
                ThaumcraftApi.registerObjectTag(new ItemStack(RECIPE_ITEMS.get("earth2")),new AspectList().add(Aspect.EARTH,2));
                ThaumcraftApi.registerObjectTag(new ItemStack(RECIPE_ITEMS.get("earth5")),new AspectList().add(Aspect.EARTH,5));
                ThaumcraftApi.registerObjectTag(new ItemStack(RECIPE_ITEMS.get("registered")),new AspectList().add(Aspect.FIRE,11));
                ThaumcraftApi.registerObjectTag(new ItemStack(RECIPE_ITEMS.get("late_seed")),new AspectList().add(Aspect.EARTH,4));
                RECIPE_ITEMS.put("cull_catalyst", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_cull_catalyst", RECIPE_ITEMS.get("cull_catalyst"));
                RECIPE_ITEMS.put("cull_output", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_cull_output", RECIPE_ITEMS.get("cull_output"));
                ThaumcraftApi.registerObjectTag(new ItemStack(RECIPE_ITEMS.get("cull_catalyst")),new AspectList().add(Aspect.AIR,1).add(Aspect.WATER,2).add(Aspect.FIRE,3).add(Aspect.EARTH,3).add(Aspect.ORDER,3).add(Aspect.ENTROPY,3).add(Aspect.MAGIC,3));
                RECIPE_ITEMS.put("cycle_siblings", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_cycle_siblings", RECIPE_ITEMS.get("cycle_siblings"));
                RECIPE_ITEMS.put("identity_nbt", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_identity_nbt", RECIPE_ITEMS.get("identity_nbt"));
                RECIPE_ITEMS.put("identity_count", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_identity_count", RECIPE_ITEMS.get("identity_count"));
                RECIPE_ITEMS.put("identity_damage", new Item(new Item.Properties().durability(100)));
                helper.register("fnd04_recipe_identity_damage", RECIPE_ITEMS.get("identity_damage"));
                RECIPE_ITEMS.put("cap", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_cap", RECIPE_ITEMS.get("cap"));
                RECIPE_ITEMS.put("arcane_remainder", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_arcane_remainder", RECIPE_ITEMS.get("arcane_remainder"));
                RECIPE_ITEMS.put("breadth", new Item(new Item.Properties()));
                helper.register("fnd04_recipe_breadth", RECIPE_ITEMS.get("breadth"));
                for (int i = 0; i < 101; i++) {
                    Item item = new Item(new Item.Properties());
                    RECIPE_ITEMS.put("depth_" + i, item);
                    helper.register("fnd04_recipe_depth_" + i, item);
                }

                ThaumcraftApi.registerObjectTag(new ItemStack(RECIPE_SEED), new AspectList().add(Aspect.EARTH, 4));
