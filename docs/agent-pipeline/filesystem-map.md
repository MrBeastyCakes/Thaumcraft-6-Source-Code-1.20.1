...
> Generated by `tools/agent-pipeline/Update-FileSystemMap.ps1` at 2026-09-18 02:14:41 UTC from commit `55975de`.
...
| Path | State / use |
|---|---|
| `src/test/java`, `src/test/resources` | 0 tracked test-source/resource files |
