...
|---|---|---|
| FND-01 | Fresh-world, reload, dedicated-server, and remote-client test procedures | The reviewed foundation checkpoint records four JUnit tests and two foundation GameTests; all five manual feature acceptance cases remain pending. See [FND-01-evidence.md](FND-01-evidence.md). |
| FND-04 | Shared aspect attribution (item, block, and entity sources), aspect container capacities, and lookup consumed by scanning and Essentia | `api/aspects` defines the aspect classes and container interfaces; parity of attribution and lookup is not yet verified. Rank-3 reference behavior captured in [fnd-04-evidence.md](fnd-04-evidence.md); the container-precedence repair is reviewed in [fnd-04-container-lookup-evidence.md](fnd-04-container-lookup-evidence.md). [Public lookup routing](fnd-04-public-lookup-evidence.md) passed independent review. The weighted seven-type culling repair passed independent review; see [culling evidence](fnd-04-culling-evidence.md). [REF-0011 live observation](fnd-04-live-crystal-2026-09-19.md) confirms the original Aer crystal AIR1 display. [REF-0014 item captures](fnd-04-live-items-2026-09-19.md) confirm original iron, diamond, iron ore and oak wood tooltip values. [Ordinary tag registration repair](fnd-04-tag-registration-evidence.md) passed independent startup/reload review, including exact tag membership and precedence checks; [REF-0015 recipe contract](fnd-04-recipe-reference-evidence.md) and [REF-0016 derived-item capture](fnd-04-live-derived-items-2026-09-19.md) support the recipe-generation repair, which passed independent specification/quality review (repair record in [fnd-04-recipe-attribution-evidence.md](fnd-04-recipe-attribution-evidence.md)) and is committed as `c6c7b1b`. [Entity attribution evidence](fnd-04-entity-attribution-evidence.md) passed independent review across two critic rounds (single ordered store, BETA26 lookup semantics with typed NBT filters and the player rule, config restorations) and is committed as `a96faf6`. [Container capacity audit](fnd-04-container-capacities-evidence.md) passed independent review (21-row census, four RED-first repairs including a phial-transfer duplication fix found by its own witnesses) and is committed as `59f53fa`. Broader gameplay evidence and full item acceptance remain pending. |
