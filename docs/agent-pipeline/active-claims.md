...
| FND-04 | FND | /root (coordinator; selecting next FND-04 slice) | codex/fnd-04-aspect-lookup | AspectHelper.java; ThaumcraftCraftingManager.java; ThaumcraftApi.java; AspectLookupGameTests.java; fnd-04 public/reference evidence; reference-catalog.md; filesystem-map.md | 2026-09-19 | 2026-09-19 | Reviewed harness gate 5acd3c2; first slice 30a58dc approved; public-lookup slice at base 2e30905 independently approved | Independent slice review; full item remains open until all acceptance evidence |
