...
Parity status is governed by [`docs/agent-pipeline/parity-workboard.md`](docs/agent-pipeline/parity-workboard.md). As of 2026-09-19 the workboard tracks **32 work items**: **1 active** (`FND-04`, container lookup slice under the reviewed foundation start gate), **1 verifying** (`FND-01`, automated harness built; manual runtime acceptance pending), **1 done** (`FND-03`, the parity evidence index), and **29 blocked** pending repairs.
